...
namespace Clases
{
    public partial class Form1 : Form
    {
        ...
        private void btnPrueba_Click(object sender, EventArgs e)
        {
            ...
            txtNombreGET.Text = respuesta.data[2].first_name.ToString();
            txtApellidoGET.Text = respuesta.data[2].last_name.ToString();
            txtEmail.Text = respuesta.data[2].email.ToString();
        }
